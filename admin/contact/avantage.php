...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./avantage.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Avantage</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="container-fluid">
    <h1 class="mb-4 text-danger">Listes des Avantages de Lorrybussiness</h1>
    <!-- Button trigger modal -->
<button type="button" class="btn btn-primary float-end mb-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
 Ajouter un avantage
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Avantage de Lorrybussiness</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="../login/avantage.php" method="post">
          ...
          <table class="table">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="../login/avantage.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    <?php  endwhile; ?>
            </table>
